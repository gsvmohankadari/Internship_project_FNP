...
# Check if input is empty or contains only whitespace " MOHAN"
        ...
        if not sentance.strip():  
            st.warning("Please enter some text! 🖊️❓Words, please! 🗣️📄Hey! ✋📚 Valid text is required")
        else:
            ...
            if prediction_class == "invalid":
                ...
                st.warning("Symbols?! 😵‍💫🚫🧙‍♂️🔮Stop trying to confuse me! 🤖⚠️ I need actual text,Not a Special symbols")
            ##
            elif  prediction_class == [1]:
                st.success("Breaking News! 📰✅ You’ve entered REAL news!🕵️‍♂️💡Reality Confirmed! 🌍📰 ")
            if  prediction_class == [0]:
                st.warning(" Uh-oh! 🕵️‍♀️❌ Fake news detected!, Let’s keep it real next time! 😂")
